...
need(D/'public/legal/cookies.html','Google AdSense may display ads on the landing page')
print('SAFEBOX_LEGAL_SURFACE_PASS')
need(landing,'id="landing-ad"'); need(landing,'2746924080'); need(landing,'adsbygoogle.push({})')
need(D/'public/ads-config.json','"landingSlot": "2746924080"')
need(ads,'Google AdSense'); need(ads,'Google AdMob')
print('SAFEBOX_ADS_LANDING_SLOT_ACTIVATION_PASS')
...
need(landing,'import.meta.env.MODE === "web"')
need(landing,'shell.hidden = false')
print('SAFEBOX_LANDING_AD_WEB_ONLY_PASS')
