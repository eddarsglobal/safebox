...
echo "NAMING_UI_R7_INVARIANTS_PASS"
...
bash verification/verify_v021_security_foundation.sh >/tmp/safebox-v021-r7.log 2>&1 || { cat /tmp/safebox-v021-r7.log; exit 1; }
grep -q 'SAFEBOX_V021_SECURITY_FOUNDATION_VERIFY_PASS' /tmp/safebox-v021-r7.log

echo "SAFEBOX_V022B_NAME_FIX_R7_VERIFY_PASS"
